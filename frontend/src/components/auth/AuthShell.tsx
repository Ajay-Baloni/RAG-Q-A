    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <aside className="relative hidden flex-col justify-between overflow-hidden bg-surface p-12 lg:flex">
        ...
        <div className="relative flex items-center gap-2.5">
          ...
          <span className="font-display text-2xl font-semibold tracking-tight text-ink">Lexica</span>
        </div>
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted">
            Upload PDFs or paste a URL, then chat with your sources. Every answer
            streams in with citations you can trace back to the exact passage.
          </p>
        </div>

        <div className="relative font-mono text-xs text-muted">
          retrieval-augmented · gemini → groq fallback · pgvector
        </div>
      </aside>
